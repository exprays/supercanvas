  ...
  return (
    <div className="flex min-h-screen bg-[#0A0B0E] text-white font-sans">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-gradient-to-br from-[#161821] to-[#0A0B0E] flex-col justify-between p-12 border-r border-white/5 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-emerald-500/5 blur-[100px] pointer-events-none" />
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl xl:text-5xl font-extrabold text-white mb-6 leading-tight">
            Start building your<br/><span className="text-brand-400 drop-shadow-md">Edge in Seconds</span>.
          </h1>
          <p className="text-gray-400 text-lg max-w-md font-light leading-relaxed">
            Join elite quants. Automate high-frequency algorithms with zero code using our visual builder and millisecond-backtesting engine.
          </p>
        </div>
        ...
        <div className="relative z-10 flex gap-4">
           <div className="flex-1 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-md p-6">
              ...
              <div className="font-bold text-white text-xl mb-1">&lt; 400ms</div>
              <div className="text-xs text-gray-500">10-year backtest speed</div>
           </div>
           <div className="flex-1 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-md p-6">
              ...
              <div className="font-bold text-white text-xl mb-1">10k+</div>
              <div className="text-xs text-gray-500">Active algorithmic traders</div>
           </div>
        </div>
      </div>
